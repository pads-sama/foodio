...
const HomepagePage: React.FC = () => {
  ...
  return (
    <>
      {/* hero section DONE */}
      <section className="bg-gradient flex flex-col items-center justify-start py-[10rem] px-[rem] h-[100dvh] sm:px-5 w-full ">
      ...
      <section className="bg-green-50 flex flex-row items-center justify-start py-[5rem] w-full">
        <div className="flex md:flex-col flex-row gap-[13px] items-start justify-start ml-[149px] md:px-5 w-[79%]">
          <div className="md:h-[558px]  h-[646px] relative w-3/5 md:w-full">
            <Img
              className="absolute h-[100%] inset-y-[0] my-auto object-contain w-[100%] "
      ...
      {/* Our Popular Chef */}
      <section className="border bg-purple-100 w-full flex justify-center">
      ...
      <section className="border bg-indigo-300 w-full flex justify-center">
      ...
      <section className="border border-red-400 w-full flex justify-center">
